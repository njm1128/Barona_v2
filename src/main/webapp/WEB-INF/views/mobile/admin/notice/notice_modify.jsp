	...
	<div class="sub pad sm wid_sm">
		...
		<form method="post" name="frm">
			...
			<table class="tbl-view">
				<tr>
					<th colspan="2"><input type="text" name="noticeTitle" value="${notice.noticeTitle}"/></th>	
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" valign="top"><p class="cont"><textarea name="noticeContent" style="min-height: 220px;">${notice.noticeContent }</textarea></p></td>
				</tr>
			</table>
		</form>
